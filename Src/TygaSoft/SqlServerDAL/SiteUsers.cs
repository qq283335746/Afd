...
namespace TygaSoft.SqlServerDAL
{
    public partial class SiteUsers
    {
        ...
        public bool IsExistUserName(string username,Guid Id)
        {
            ...
            object obj = SqlHelper.ExecuteScalar(SqlHelper.AfdDbConnString, CommandType.Text, cmdText, parms);
        ...
        public SiteUsersInfo GetModel(string username)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.AfdDbConnString, CommandType.Text, cmdText, parm))
            {
                if (reader != null)
                {
                    if (reader.Read())
        ...
        public SiteUsersInfo GetModelByJoin(string username,object Id)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.AfdDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    if (reader.Read())
