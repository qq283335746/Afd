var Customer = {
    ...
    Load: function (pageIndex, pageSize) {
        ...
        var url = Common.AppName + '/Services/AfdService.svc/GetCustomerList';
    ...
    Add: function () {
        ...
        $("#dlgAddCustomer").dialog({
            ...
            href: Common.AppName + '/afd/u/tcustomer.html'
        })
        return false;
    },
    Edit: function () {
    ...
    Del: function () {
        ...
        $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
            if (r) {
                ...
                var url = Common.AppName + "/Services/AfdService.svc/DeleteCustomer";
                Common.Ajax(url, postData, "POST", "", true, true, function (result) {
    ...
    Save: function () {
        ...
        var url = Common.AppName + "/Services/AfdService.svc/SaveCustomer";
        Common.Ajax(url, postData, "POST", "", true, true, function (result) {
            $("#dlgAddCustomer").dialog('close');
            jeasyuiFun.show("温馨提示", "保存成功！");
            setTimeout(function () {
